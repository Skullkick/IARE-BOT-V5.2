...
> **New to IARE Bot?** Refer to the **[Student User Guide](BEGINNERS_GUIDE.md)** for a complete step-by-step walkthrough of student commands, interactive buttons, settings, and troubleshooting.
